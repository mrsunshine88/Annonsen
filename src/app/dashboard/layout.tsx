          ...
          <div className="admin-nav-desktop">
            ...
            {isEmployer ? (
              <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <Link href="/dashboard/foretagssida" className="dashboard-link" style={{ display: 'block', margin: '0.2rem 0' }}>Din Företagssida</Link>
              </nav>
            ) : (
              <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <details style={{ outline: 'none' }}>
              ...
              {isEmployer ? (
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0', marginTop: '0.5rem', borderTop: '1px solid var(--color-border)' }}>
                  ...
                  <Link href="/dashboard/foretagssida" style={{ display: 'block', padding: '1rem 0', color: 'var(--color-primary)', fontWeight: 600 }}>Din Företagssida</Link>
                </nav>
              ) : (
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0', marginTop: '0.5rem', borderTop: '1px solid var(--color-border)' }}>
